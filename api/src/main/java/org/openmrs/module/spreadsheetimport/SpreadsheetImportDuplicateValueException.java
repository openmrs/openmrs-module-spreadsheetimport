 ...
 *
 */
public class SpreadsheetImportDuplicateValueException extends Exception {
	
	SpreadsheetImportTemplateColumn column;
	
	public SpreadsheetImportDuplicateValueException(SpreadsheetImportTemplateColumn column) {
		this.column = column;
	}
